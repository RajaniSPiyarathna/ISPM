...
<html lang="en">
   <head>
      ...
      <title>Edit Employee - LECO Security Awareness</title>
      <!-- Bootstrap 5 CSS -->
    ...
    <div class="sidebar">
      ...
      <div class="main-content">
         <div class="profile-card">
            ...
            <!-- Include employee ID in the action URL -->
            <form method="POST" action="edit-employee.php?id=<?php echo $user_id; ?>">
               <div class="mb-3">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="tel" name="tel" value="<?php echo $user['tel']; ?>">
               </div>
